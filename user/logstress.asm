...
stat(const char *n, struct stat *st)
{
 ...
 24a:	892e                	mv	s2,a1
  ...
  fd = open(n, O_RDONLY);
 24c:	4581                	li	a1,0
 24e:	192000ef          	jal	ra,3e0 <open>
  if(fd < 0)
 252:	02054163          	bltz	a0,274 <stat+0x36>
 256:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 258:	85ca                	mv	a1,s2
 25a:	19e000ef          	jal	ra,3f8 <fstat>
 25e:	892a                	mv	s2,a0
  close(fd);
 260:	8526                	mv	a0,s1
 262:	166000ef          	jal	ra,3c8 <close>
  return r;
}
 266:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 360:	f63ff0ef          	jal	ra,2c2 <memmove>
}
 364:	60a2                	ld	ra,8(sp)
 366:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 38a:	4589                	li	a1,2
 38c:	09c000ef          	jal	ra,428 <sys_sbrk>
}
 390:	60a2                	ld	ra,8(sp)
 392:	6402                	ld	s0,0(sp)

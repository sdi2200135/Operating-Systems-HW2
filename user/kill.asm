...
main(int argc, char **argv)
{
  ...
  for(i=1; i<argc; i++)
    kill(atoi(argv[i]));
  26:	6088                	ld	a0,0(s1)
  28:	19e000ef          	jal	ra,1c6 <atoi>
  2c:	2f2000ef          	jal	ra,31e <kill>
  for(i=1; i<argc; i++)
  30:	04a1                	addi	s1,s1,8
  32:	ff249ae3          	bne	s1,s2,26 <main+0x26>
  exit(0);
  36:	4501                	li	a0,0
  38:	2b6000ef          	jal	ra,2ee <exit>
    fprintf(2, "usage: kill pid...\n");
...
stat(const char *n, struct stat *st)
{
 ...
 198:	892e                	mv	s2,a1
  ...
  fd = open(n, O_RDONLY);
 19a:	4581                	li	a1,0
 19c:	192000ef          	jal	ra,32e <open>
  if(fd < 0)
 1a0:	02054163          	bltz	a0,1c2 <stat+0x36>
 1a4:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 1a6:	85ca                	mv	a1,s2
 1a8:	19e000ef          	jal	ra,346 <fstat>
 1ac:	892a                	mv	s2,a0
  close(fd);
 1ae:	8526                	mv	a0,s1
 1b0:	166000ef          	jal	ra,316 <close>
  return r;
}
 1b4:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 2ae:	f63ff0ef          	jal	ra,210 <memmove>
}
 2b2:	60a2                	ld	ra,8(sp)
 2b4:	6402                	ld	s0,0(sp)
...
sbrk(int n) {
 ...
 2c2:	4585                	li	a1,1
 2c4:	0b2000ef          	jal	ra,376 <sys_sbrk>
}
 2c8:	60a2                	ld	ra,8(sp)
 2ca:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 2d8:	4589                	li	a1,2
 2da:	09c000ef          	jal	ra,376 <sys_sbrk>
}
 2de:	60a2                	ld	ra,8(sp)
 2e0:	6402                	ld	s0,0(sp)
